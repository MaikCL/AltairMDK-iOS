/**
 ...
 Snippet found in https://gist.github.com/ollieatkinson/322338df8a5220d649ac01ff11e7de12
 Thanks to https://github.com/ollieatkinson
 */

// TODO: Improvement with localizable strings (CODE: Localizable Description) - @mzapatae.22/04/20
...
public enum HTTPStatusCode: Int, Error {
    ...
    /// - undefined: The status code does not exist or is undefined
    case undefined = -1
    
    init(rawCode: Int){
        self = HTTPStatusCode(rawValue: rawCode) ?? .undefined
    }
